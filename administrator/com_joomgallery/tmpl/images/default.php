          ...
          <table class="table table-striped" id="imageList">
            ...
            <tbody <?php if ($saveOrder) :?> class="js-draggable" data-url="<?php echo $saveOrderingUrl; ?>" data-direction="<?php echo \strtolower($listDirn); ?>" <?php endif; ?>>
              <?php foreach ($this->items as $i => $item) :
                ...
                $canEdit    = $this->getAcl()->checkACL('edit', _JOOM_OPTION.'.image', $item->catid, true);
                $canEditCat = $this->getAcl()->checkACL('edit', _JOOM_OPTION.'.category.'.$item->catid);
                $canCheckin = $user->authorise('core.manage', 'com_checkin') || $item->checked_out == $userId || is_null($item->checked_out);
                $canChange  = $this->getAcl()->checkACL('editstate', _JOOM_OPTION.'.image', $item->catid, true) && $canCheckin;
                ?>
