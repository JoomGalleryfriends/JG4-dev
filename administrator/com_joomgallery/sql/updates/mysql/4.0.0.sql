...
`jg_record_hits_select` VARCHAR(50) NOT NULL DEFAULT "detail",
...
`jg_category_view_subcategory_type_images` VARCHAR(50) NOT NULL DEFAULT "thumbnail",
...
`jg_category_view_ord_images` VARCHAR(100) NOT NULL DEFAULT "a.date ASC",
`jg_category_view_type_images` VARCHAR(50) NOT NULL DEFAULT "thumbnail",
...
`jg_category_view_lightbox_image` VARCHAR(50) NOT NULL DEFAULT "detail",
...
`jg_detail_view_type_image` VARCHAR(50) NOT NULL DEFAULT "detail",
