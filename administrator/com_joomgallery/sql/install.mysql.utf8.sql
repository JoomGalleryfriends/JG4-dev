...
`jg_category_view_show_title` TINYINT(1) NOT NULL DEFAULT 1,
`jg_category_view_caption_align` VARCHAR(100) NOT NULL DEFAULT "center",
`jg_category_view_image_class` VARCHAR(100) NOT NULL DEFAULT "None",
`jg_category_view_justified_height` INT NOT NULL DEFAULT 200,
`jg_category_view_justified_gap` TINYINT(1) NOT NULL DEFAULT 5,
`jg_category_view_numb_subcategories` INT(3) NOT NULL DEFAULT 12,
`jg_category_view_numb_images` INT(4) NOT NULL DEFAULT 16,
