...
const renderDebug = (props) => props.file.debughtml && (
  <div className="uppy-Dashboard-Item-debug">
    {props.file.debughtml}
  </div>
)

const renderState = (props) => props.file.statehtml && (
  <div className="uppy-Dashboard-Item-state">
