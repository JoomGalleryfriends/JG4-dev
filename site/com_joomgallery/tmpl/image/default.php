...
$canDelete  = $this->getAcl()->checkACL('delete', 'com_joomgallery.image', $this->item->catid, true);
$canCheckin = $this->getAcl()->checkACL('editstate', 'com_joomgallery.image', $this->item->catid, true) || $this->item->checked_out == Factory::getUser()->id;
